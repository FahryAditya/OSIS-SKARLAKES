...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 rounded-2xl p-4 sm:p-6 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4">
          <div className="flex items-center space-x-3 sm:space-x-4">
            ...
            <div className="min-w-0">
              ...
              <h1 className="text-base sm:text-2xl font-black tracking-tight leading-tight truncate">
                {config.name}
              </h1>
              <p className="text-2xs sm:text-sm text-slate-300 mt-0.5 sm:mt-1 max-w-2xl line-clamp-2 sm:line-clamp-none">
                {config.tagline} • Sistem Terpadu Presensi & Transparansi Keuangan
              </p>
            </div>
          </div>

          <div className="flex flex-col xs:flex-row items-stretch xs:items-center justify-start md:justify-end gap-2 sm:gap-3 md:ml-auto shrink-0 pt-1 md:pt-0">
            <button
              onClick={onOpenSelfCheckIn}
              className="px-3.5 py-2 sm:py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs sm:text-sm font-bold flex items-center justify-center space-x-2 shadow-md transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 sm:py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs sm:text-sm font-bold flex items-center justify-center space-x-2 shadow-md transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
